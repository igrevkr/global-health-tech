...
const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    // HomePage Specific
    "home.hero.headerText": "GLOBAL MARKETING CENTER STRATEGY REPORT",
    ...
    // GlobalNetworkMap
    "network.badge": "GLOBAL NETWORK",
    "network.title2": "Unique Global PoC Network",
    "network.subtitle2": "3 Core Hubs with High Credibility Based on National/Public Institutions",
    "network.why": "Why GBPL Network?",
    "network.whyDesc": "Credibility through national/MOH linkage, not private hospitals · Beyond simple agreements to actual PoC execution",
    "network.hub.uk.name": "UK (European Advanced Market)",
    "network.hub.uk.city": "Bristol NHS Medical Staff Collaboration",
    "network.hub.uk.status": "MOU Signed & PoC Project Started",
    "network.hub.uk.description": "Liver/Chest Disease AI PoC and Clinical Feedback, Brain Tumor AI Joint Research Discussion",
    "network.hub.uk.highlight": "NHS-centered Medical AI Adoption Rate 60% Market",
    "network.hub.chile.name": "Chile (LatAm Bridgehead)",
    "network.hub.chile.city": "BIOANDINA SPA, MOH Linkage",
    "network.hub.chile.status": "MOU Signed & PoC Project Started",
    "network.hub.chile.description": "Pilot Application in Line with Government Health Digitalization, LatAm Market Entry Test Bed",
    "network.hub.brazil.name": "Brazil (Largest LatAm Market)",
    "network.hub.brazil.city": "Local Medical Institution Partnership",
    "network.hub.brazil.status": "MOU Signed & PoC Project Started",
    "network.hub.brazil.description": "Suitability Verification for Local Registration and Sales, Confirming Largest Market in South America",
    "network.hub.brazil.highlight": "ANVISA Registration Support Available",
    "network.hub.seoul": "Seoul HQ",
    "network.panel.partner": "Partner",
    "network.panel.activities": "Key Activities",
    "network.stat.hubs": "Global Hubs",
    "network.stat.hubsDesc": "UK · Chile · Brazil",
    "network.stat.public": "National/Public Institution Linkage",
    "network.stat.publicDesc": "High Credibility Secured",
    "network.stat.active": "Active",
    "network.stat.activeLabel": "Actual PoC Execution",
    "network.stat.activeDesc": "Beyond Simple Agreements",

    // FinancialChart
    "financial.badge": "FINANCIAL STABILITY",
    "financial.title2": "Financial Stability & Growth Momentum",
    "financial.subtitle2": "Explosive Early Growth and Proven Large Project Execution Capability",
    "financial.growth.title": "Explosive Quantitative Growth (2023 vs 2024)",
    "financial.revenue.label": "REVENUE",
    "financial.revenue.unit": "B KRW",
    "financial.revenue.growth": "52% Growth",
    "financial.revenue.compare": "vs 1.23B in 2023",
    "financial.employees.label": "EMPLOYEES",
    "financial.employees.unit": "people",
    "financial.employees.growth": "166% Increase",
    "financial.employees.compare": "vs 6 in 2023",
    "financial.strategy.title": "2025 Strategy",
    "financial.strategy.desc": "Conservatively adjusting revenue target (1.6-1.8B) to focus on high-value global business, reorganizing around core talent for consolidation.",
    "financial.tech.title": "Proven Technical Stability",
    "financial.tech.subtitle": "IT/Security Capability Proven Through Large Financial and Enterprise Projects",
    "financial.track.aia": "AIA Life Customer Portal Enhancement",
    "financial.track.aia.desc": "Financial-grade Security and Large-scale Traffic Handling",
    "financial.track.kyobo": "Kyobo Book Centre Reading Tree Rebuild",
    "financial.track.kyobo.desc": "Customer Service Platform Stability Secured",
    "financial.track.hyundai": "Hyundai Motor Group Affiliate SI",
    "financial.track.hyundai.desc": "Enterprise-grade System Integration Capability",
    "financial.cashcow.title": "Stable Cash Cow Secured",
    "financial.cashcow.desc": "The stable revenue base from existing SI/ITO business offsets initial risks of global medical AI business and enables sustainable investment.",
    "financial.chart.title": "Annual Revenue and Workforce Trend",
    "financial.chart.revenue": "Revenue",
    "financial.chart.workforce": "Workforce",
  ...
  KO: {
    ...
    // HomePage Specific
    "home.hero.headerText": "글로벌 마케팅 센터 전략 보고서",
    ...
    // GlobalNetworkMap
    "network.badge": "GLOBAL NETWORK",
    "network.title2": "독보적인 글로벌 PoC 네트워크",
    "network.subtitle2": "국영·공공 기관 기반의 공신력 높은 3대 핵심 거점 확보",
    "network.why": "Why GBPL Network?",
    "network.whyDesc": "사설 병원이 아닌 국영/보건부 연계로 공신력 확보 · 단순 협약을 넘어선 실질적 PoC 수행 단계",
    "network.hub.uk.name": "영국 (유럽 선진 시장)",
    "network.hub.uk.city": "Bristol NHS 의료진 협력",
    "network.hub.uk.status": "MOU 체결 및 실증 프로젝트 착수",
    "network.hub.uk.description": "간질환/흉부질환 AI 실증 및 임상 피드백 확보, 뇌종양 변화 관찰 AI 공동연구 논의 중",
    "network.hub.uk.highlight": "NHS 중심 의료 AI 도입률 60% 시장",
    "network.hub.chile.name": "칠레 (중남미 교두보)",
    "network.hub.chile.city": "BIOANDINA SPA, 보건부 연계",
    "network.hub.chile.status": "MOU 체결 및 실증 프로젝트 착수",
    "network.hub.chile.description": "정부 보건 디지털화 추진에 발맞춘 시범 적용, 중남미 시장 진입 전 실증 테스트베드",
    "network.hub.brazil.name": "브라질 (중남미 최대 시장)",
    "network.hub.brazil.city": "현지 의료기관 파트너십",
    "network.hub.brazil.status": "MOU 체결 및 실증 프로젝트 착수",
    "network.hub.brazil.description": "현지 등록 및 판매를 위한 적합성 검증 수행, 남미 최대 규모 시장성 확인",
    "network.hub.brazil.highlight": "ANVISA 등록 연계 지원 가능",
    "network.hub.seoul": "서울 본사",
    "network.panel.partner": "파트너",
    "network.panel.activities": "주요 활동",
    "network.stat.hubs": "글로벌 거점",
    "network.stat.hubsDesc": "영국 · 칠레 · 브라질",
    "network.stat.public": "국영/공공 기관 연계",
    "network.stat.publicDesc": "높은 공신력 확보",
    "network.stat.active": "Active",
    "network.stat.activeLabel": "실질적 PoC 수행",
    "network.stat.activeDesc": "단순 협약을 넘어선 실행",

    // FinancialChart
    "financial.badge": "FINANCIAL STABILITY",
    "financial.title2": "재무 안정성 및 성장 모멘텀",
    "financial.subtitle2": "폭발적인 초기 성장세와 탄탄한 대형 프로젝트 수행 역량 입증",
    "financial.growth.title": "폭발적 양적 성장 (2023 vs 2024)",
    "financial.revenue.label": "REVENUE",
    "financial.revenue.unit": "억",
    "financial.revenue.growth": "52% 성장",
    "financial.revenue.compare": "2023년 12.3억 대비",
    "financial.employees.label": "EMPLOYEES",
    "financial.employees.unit": "명",
    "financial.employees.growth": "166% 증가",
    "financial.employees.compare": "2023년 6명 대비",
    "financial.strategy.title": "2025년 전략",
    "financial.strategy.desc": "고부가가치 글로벌 사업 집중을 위해 매출 목표를 보수적으로 조정(16~18억)하고, 핵심 인력 위주로 조직을 재편하여 내실 다지기에 주력.",
    "financial.tech.title": "검증된 기술 안정성",
    "financial.tech.subtitle": "대형 금융 및 기업 프로젝트 수행으로 입증된 IT/보안 역량",
    "financial.track.aia": "AIA생명 고객포털 고도화",
    "financial.track.aia.desc": "금융권 수준의 보안 및 대규모 트래픽 처리",
    "financial.track.kyobo": "교보문고 리딩트리 재구축",
    "financial.track.kyobo.desc": "대고객 서비스 플랫폼 안정성 확보",
    "financial.track.hyundai": "현대자동차 그룹 계열사 SI",
    "financial.track.hyundai.desc": "엔터프라이즈급 시스템 통합 역량",
    "financial.cashcow.title": "안정적 캐시카우 확보",
    "financial.cashcow.desc": "기존 SI/ITO 사업의 안정적인 수익 기반은 글로벌 의료 AI 사업의 초기 리스크를 상쇄하고 지속 가능한 투자를 가능하게 합니다.",
    "financial.chart.title": "연도별 매출 및 인력 추이",
    "financial.chart.revenue": "매출",
    "financial.chart.workforce": "인력",
