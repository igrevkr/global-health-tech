...
const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    // HomePage Specific
    "home.hero.badge": "2025 Seoul SBA Strategic Proposal",
    "home.hero.title1": "Global Marketing Center",
    "home.hero.title2": "Entry Strategy Report",
    "home.hero.subtitle1": "Medical AI technology-based",
    "home.hero.subtitle2": "Seoul SME PoC-based Export Support Specialist",
    "home.hero.company": "GBPL Co., Ltd.",
    "home.hero.presenter": "Presenter: Kim Subong (CEO · 13-year Full-stack Developer)",
    "home.hero.foundation": "FOUNDATION",
    "home.hero.foundationDate": "Founded June 1, 2022",
    "home.hero.foundationDesc": "Stable technology-based growth",
    "home.hero.certification": "CERTIFICATION",
    "home.hero.certificationValue": "R&D Center · Venture Enterprise",
    "home.hero.certificationDesc": "AI Voucher Supplier Registered",
    "home.hero.revenue": "2024 REVENUE",
    "home.hero.revenueValue": "KRW 1.88B Achieved",
    "home.hero.revenueDesc": "52% YoY High Growth",
    
    "home.core.badge": "CORE BUSINESS",
    "home.core.title": "GBPL Core Service Model",
    "home.core.subtitle": "4 Major Export Services for Global Success of Korean Medical Companies",
    "home.core.description": "Building an integrated export ecosystem based on platform, not single product sales.",
    
    "home.service1.title": "AI-based Medical Imaging Analysis Platform",
    "home.service1.subtitle": "University Hospital Collaboration Technology",
    "home.service1.item1": "Upper Abdominal Ultrasound Analysis - Fatty Liver Auto-Analysis AI",
    "home.service1.item2": "Chest X-ray Diagnosis - Pneumonia, Nodule, Pleural Disease Detection",
    "home.service1.item3": "Export-oriented SaaS Model Foundation",
    
    "home.service2.title": "Overseas Medical Institution PoC Linkage",
    "home.service2.subtitle": "Direct Hospital Collaboration Testing",
    "home.service2.item1": "Verification based on local medical staff collaboration",
    "home.service2.item2": "Actual clinical data acquisition and feedback",
    "home.service2.item3": "Technical verification service report provision",
    "home.service2.item4": "UK, Chile, Brazil hub utilization",
    
    "home.service3.title": "Korean Medical Company Global Expansion Support",
    "home.service3.subtitle": "Full-cycle Export Execution",
    "home.service3.item1": "Regulatory/Certification Guide (FDA/CE)",
    "home.service3.item2": "Country-specific Market Research and Demand Analysis",
    "home.service3.item3": "Overseas Buyer/Distributor Matching",
    "home.service3.item4": "Overseas Sales Strategy Consulting",
    
    "home.service4.title": "Medical Solution Joint-Package",
    "home.service4.subtitle": "H/W + S/W Bundle Export Model",
    "home.service4.item1": "Own AI S/W + Korean Medical Devices (Ultrasound, Body Composition Equipment, etc.)",
    "home.service4.item2": "Maximize Market Entry Probability and Efficiency",
    "home.service4.item3": "PoC Success Rate Enhancement Strategy",
    
    "home.core.flow1": "Own Technology",
    "home.core.flow2": "Global Network",
    "home.core.flow3": "Execution Partnership",
    
    "home.problem.title": "Problem Definition | GBPL's Role",
    "home.problem.subtitle": "Global Expansion Bottlenecks and Solutions for Seoul Medical/Healthcare SMEs",
    "home.problem.barriers": "3 Major Market Entry Barriers",
    "home.problem.barriersDesc": "Real difficulties faced by excellent domestic companies when expanding overseas",
    "home.problem.barrier1.title": "Complex Regulatory Barriers",
    "home.problem.barrier1.desc": "FDA, CE and other certification procedures are complex and prolonged, creating very high initial entry risk",
    "home.problem.barrier2.title": "Data Compatibility Issues",
    "home.problem.barrier2.desc": "Inconsistent medical data standards by country cause difficulties in local system integration and suitability verification",
    "home.problem.barrier3.title": "Lack of Local PoC Opportunities",
    "home.problem.barrier3.desc": "Most critical issue: Nearly impossible to secure an environment to test products at actual overseas hospitals",
    
    "home.mission.title": "GBPL MISSION",
    "home.mission.heading1": "Fusion of Medical AI Technology and PoC Network",
    "home.mission.desc1": "Beyond simple consulting, we directly connect technology and the field.",
    "home.mission.heading2": "Dramatically Reduce Initial Entry Risk",
    "home.mission.desc2": "Accelerate global success of Seoul SMEs by providing actual hospital environment testing",
    "home.mission.pillar1": "Medical AI Technology",
    "home.mission.pillar1.desc": "Own development capability and technology understanding",
    "home.mission.pillar2": "Overseas PoC Network",
    "home.mission.pillar2.desc": "Direct connection to UK, Chile, Brazil hospitals",
    "home.mission.pillar3": "Export Execution",
    "home.mission.pillar3.desc": "Full-cycle support for certification, distribution, marketing",
    
    "home.conclusion.badge": "CONCLUSION",
    "home.conclusion.title": "Summary and Recommendations",
    "home.conclusion.subtitle": "GBPL's Firm Vision and Promise for Global Success of Seoul SMEs",
    
    "home.conclusion.col1.title": "Unique Fusion Model",
    "home.conclusion.col1.desc": "Integrated export platform tailored for Seoul SMEs combining medical AI technology and overseas PoC network",
    "home.conclusion.col1.item1": "Own AI technology capability",
    "home.conclusion.col1.item2": "UK, Chile, Brazil 3 major hubs",
    "home.conclusion.col1.item3": "One-stop regulatory/certification support",
    
    "home.conclusion.col2.title": "Proven Execution Capability",
    "home.conclusion.col2.desc": "Stable business execution capability proven by explosive revenue growth and certified technology",
    "home.conclusion.col2.item1": "52% revenue growth in 2024",
    "home.conclusion.col2.item2": "R&D Center/Venture Certification",
    "home.conclusion.col2.item3": "Large SI/Financial project completion",
    
    "home.conclusion.col3.title": "Center Vision Contribution",
    "home.conclusion.col3.desc": "Beyond simple tenancy, activate the center as a global export hub and grow together with Seoul companies",
    "home.conclusion.col3.item1": "10 companies joint expansion by 2027",
    "home.conclusion.col3.item2": "Lead center infrastructure globalization",
    "home.conclusion.col3.item3": "Overseas buyer attraction and matching",
    
    "home.conclusion.final.title": "The Optimal Partner, GBPL Will Be With You.",
    "home.conclusion.final.desc": "We will focus all of GBPL's capabilities to strengthen Seoul Business Agency's global influence and expand the domestic medical healthcare industry.",
    "home.conclusion.cta1": "Contact Us",
    "home.conclusion.cta2": "View Company Profile",
  ...
  KO: {
    ...
    // HomePage Specific
    "home.hero.badge": "2025 서울 SBA 전략 제안서",
    "home.hero.title1": "글로벌마케팅센터",
    "home.hero.title2": "입주 전략 보고서",
    "home.hero.subtitle1": "의료 AI 기술 기반의",
    "home.hero.subtitle2": "서울 중소기업 실증형 수출 지원 전문 기업",
    "home.hero.company": "지비피엘 주식회사",
    "home.hero.presenter": "발표자 : 김수봉 (대표이사 · 13년차 풀스택 개발자)",
    "home.hero.foundation": "FOUNDATION",
    "home.hero.foundationDate": "2022. 06. 01 설립",
    "home.hero.foundationDesc": "안정적 기술 기반 성장",
    "home.hero.certification": "CERTIFICATION",
    "home.hero.certificationValue": "기업부설연구소 · 벤처기업",
    "home.hero.certificationDesc": "AI 바우처 공급기업 등록",
    "home.hero.revenue": "2024 REVENUE",
    "home.hero.revenueValue": "18.8억 원 달성",
    "home.hero.revenueDesc": "전년 대비 52% 고속 성장",
    
    "home.core.badge": "CORE BUSINESS",
    "home.core.title": "GBPL 핵심 서비스 모델",
    "home.core.subtitle": "국내 의료 기업의 글로벌 성공을 위한 4대 수출 주력 서비스",
    "home.core.description": "단일 제품 판매가 아닌, 플랫폼 기반의 통합 수출 생태계를 구축합니다.",
    
    "home.service1.title": "AI 기반 의료영상 분석 플랫폼",
    "home.service1.subtitle": "대학병원 협력 자체 기술력 확보",
    "home.service1.item1": "상복부 초음파 분석 - 지방간 정도 자동 분석 AI",
    "home.service1.item2": "흉부 X-ray 진단 - 폐렴·결절·흉막 질환 검출",
    "home.service1.item3": "수출형 SaaS 모델 구축 기반",
    
    "home.service2.title": "해외 의료기관 실증(PoC) 연계",
    "home.service2.subtitle": "현지 병원 직접 협력 테스트",
    "home.service2.item1": "현지 의료진 협업 기반 검증",
    "home.service2.item2": "실제 임상 데이터 확보 및 피드백",
    "home.service2.item3": "기술 검증 서비스 리포트 제공",
    "home.service2.item4": "영국·칠레·브라질 거점 활용",
    
    "home.service3.title": "국내 의료기업 해외 진출 지원",
    "home.service3.subtitle": "전주기적 수출 실행력 제공",
    "home.service3.item1": "규제/인허가 가이드 (FDA/CE)",
    "home.service3.item2": "국가별 시장조사 및 수요분석",
    "home.service3.item3": "해외 바이어/유통사 매칭",
    "home.service3.item4": "해외 판매 전략 수립 컨설팅",
    
    "home.service4.title": "의료 솔루션 Joint-Package",
    "home.service4.subtitle": "H/W + S/W 묶음 수출 모델",
    "home.service4.item1": "자체 AI S/W + 국내 의료기기 (초음파, 체성분 장비 등)",
    "home.service4.item2": "시장 진입 확률 및 효율 극대화",
    "home.service4.item3": "실증 성공률 제고 전략",
    
    "home.core.flow1": "자체 기술력",
    "home.core.flow2": "글로벌 네트워크",
    "home.core.flow3": "실행 파트너십",
    
    "home.problem.title": "문제 정의 | GBPL의 역할",
    "home.problem.subtitle": "서울 의료·헬스케어 중소기업의 글로벌 진출 병목과 해법",
    "home.problem.barriers": "시장 진입의 3대 장벽",
    "home.problem.barriersDesc": "국내 우수 기업들이 해외 진출 시 직면하는 현실적인 어려움",
    "home.problem.barrier1.title": "복잡한 규제 장벽",
    "home.problem.barrier1.desc": "FDA, CE 등 인허가 절차가 복잡하고 장기화되어 초기 진입 리스크가 매우 큼",
    "home.problem.barrier2.title": "데이터 호환성 문제",
    "home.problem.barrier2.desc": "국가별 의료 데이터 표준 불일치로 현지 시스템 연동 및 적합성 검증 난항",
    "home.problem.barrier3.title": "현지 실증(PoC) 기회 부재",
    "home.problem.barrier3.desc": "가장 치명적인 문제: 실제 해외 병원에서 제품을 테스트할 환경 확보가 거의 불가능",
    
    "home.mission.title": "GBPL MISSION",
    "home.mission.heading1": "의료 AI 기술과 실증 네트워크의 융합",
    "home.mission.desc1": "단순 컨설팅을 넘어, 기술과 현장을 직접 연결합니다.",
    "home.mission.heading2": "초기 진입 리스크 획기적 경감",
    "home.mission.desc2": "실제 병원 환경 테스트 제공으로 서울 중소기업의 글로벌 성공 가속화",
    "home.mission.pillar1": "의료 AI 기술",
    "home.mission.pillar1.desc": "자체 개발 역량 및 기술 이해도",
    "home.mission.pillar2": "해외 실증 네트워크",
    "home.mission.pillar2.desc": "영국·칠레·브라질 병원 직접 연결",
    "home.mission.pillar3": "수출 실행력",
    "home.mission.pillar3.desc": "인허가·유통·마케팅 전주기 지원",
    
    "home.conclusion.badge": "CONCLUSION",
    "home.conclusion.title": "요약 및 제언",
    "home.conclusion.subtitle": "서울 중소기업의 글로벌 성공을 위한 GBPL의 확고한 비전과 약속",
    
    "home.conclusion.col1.title": "독보적 융합 모델",
    "home.conclusion.col1.desc": "의료 AI 기술과 해외 실증 네트워크를 결합한 서울 중소기업 맞춤형 통합 수출 플랫폼",
    "home.conclusion.col1.item1": "자체 AI 기술력 보유",
    "home.conclusion.col1.item2": "英·칠레·브라질 3대 거점",
    "home.conclusion.col1.item3": "규제·인허가 원스톱 지원",
    
    "home.conclusion.col2.title": "검증된 실행 역량",
    "home.conclusion.col2.desc": "폭발적인 매출 성장과 공인된 기술력으로 증명된 안정적인 사업 수행 능력",
    "home.conclusion.col2.item1": "2024년 매출 52% 성장",
    "home.conclusion.col2.item2": "기업부설연구소/벤처 인증",
    "home.conclusion.col2.item3": "대형 SI/금융 프로젝트 완수",
    
    "home.conclusion.col3.title": "센터 비전 기여",
    "home.conclusion.col3.desc": "단순 입주를 넘어 센터를 글로벌 수출 허브로 활성화하고 서울 기업과 동반 성장",
    "home.conclusion.col3.item1": "2027년 10개사 동반 진출",
    "home.conclusion.col3.item2": "센터 인프라 글로벌화 선도",
    "home.conclusion.col3.item3": "해외 바이어 유치 및 매칭",
    
    "home.conclusion.final.title": "최적의 파트너, GBPL이 함께 하겠습니다.",
    "home.conclusion.final.desc": "서울경제진흥원의 글로벌 영향력 강화와 국내 의료 헬스케어 산업의 확산을 위해 GBPL의 모든 역량을 집중하겠습니다.",
    "home.conclusion.cta1": "문의하기",
    "home.conclusion.cta2": "회사 소개 보기",
